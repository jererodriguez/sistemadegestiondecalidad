$(document).ready(function () {
	...
	jsonData.data.forEach(function (fila) {
		var row = '<tr>';
		...
		row += '<td><div class="userDatatable-content">' + data.email + '</div></td>';
		row += '<td><div class="userDatatable-content">' + data.company + '</div></td>';
		row += '<td><div class="userDatatable-content">' + data.position + '</div></td>';
		row += '<td><div class="userDatatable-content">' + data.join_date + '</div></td>';
		row += '<td><div class="userDatatable-content d-inline-block"><span class="bg-opacity-success  color-success rounded-pill userDatatable-content-status ' + (data.status === 'active' ? 'active' : 'inactive') + '">' + data.status + '</span></div></td>';
...
/*
Me podrias actualizar este script con los datos a continuacion?

<tr>
    <td class="Product-cart-title">
        <div class="media  align-items-center">
            <img class="mr-3 wh-50 align-self-center radius-xl bg-opacity-primary"
                src="data.foto" alt="data.producto">
            <div class="media-body">
                <h5 class="mt-0">data.producto</h5>
                <div class="d-flex">
    ...
    <td class="text-center subtotal">qty qh-36 input * data.precio</td>
    <td class="actions">
