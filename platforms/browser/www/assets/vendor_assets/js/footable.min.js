...
function(a, b) {
    b.Filtering = b.Component.extend({
        ...
        setButton: function(a) {
            a ? this.$button.children(".fooicon").removeClass("fooicon-remove").addClass("fooicon-search") : this.$button.children(".fooicon").removeClass("fooicon-search").addClass("fooicon-remove reset-button")
        },
        find: function(a) {
        ...
        _onSearchButtonClicked: function(a) {
            ...
            console.log("Se ha presionado el botón de reseteo");
            categoriasSeleccionadas = [];
            $("#select_cat").val(null).trigger("change");

            if (c.hasClass("fooicon-remove")) {
                // Si el botón tiene la clase "fooicon-remove", se realiza un reset
                b.clear();
            } else {
                // Si no tiene la clase "fooicon-remove", se aplican los filtros
                var d = b.$input.val();
    ...
    b.Sorting = b.Component.extend({
        ...
        predraw: function() {
            if (!b.is.emptyArray(this.filters)) {
                ...
                // Filtrar las filas y contar cuántas filas resultantes
                var filteredRows = a.grep(c.ft.rows.array, function(row) {
                    return row.filtered(c.filters);
                });
        
                // Mostrar el número de filas resultantes
                console.log("Número de filas resultantes después de la búsqueda:", filteredRows.length);
        
                // Mostrar el contenido de cada fila resultante
                filteredRows.forEach(function(row) {
                    console.log("Contenido de la fila:", row.cells.map(function(cell) { return cell.$el.text(); }));
                });
        
                c.ft.rows.array = filteredRows;
            }
        }
        ,
        draw: function() {
